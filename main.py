...
path = str(input("Enter the path to data folder: "))
dataset = "2"
cfile = path + "/cam/cam" + dataset + ".p"
ifile = path + "/imu/imuRaw" + dataset + ".p"
vfile = path + "/vicon/viconRot" + dataset + ".p"
# cfile = r"/home/surya/Desktop/ucsd/ECE276A/PR1/testData/cam/cam" + dataset + ".p"
# ifile = r"/home/surya/Desktop/ucsd/ECE276A/PR1/testData/imu/imuRaw" + dataset + ".p"
# ts = tic()
